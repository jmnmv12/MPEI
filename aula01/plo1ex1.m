...
% entre 0.0 e 1.0 (ou seja, cada coluna representa uma experiencia):experiencias = rand(3,10000);
...
% valor 0 caso contrario (ou seja, saiu coroa):lancamentos = experiencias > 0.5; % 0.5 corresponde a 1 - prob. de caras
% Gerar um vetor linha com 10000 elementos com a soma dos valores de cada
% coluna da matriz anterior (ou seja, o numero de caras de cada experiencia):resultados= sum(lancamentos);
...
% diferente de 2:sucessos= resultados==2;
% Determinar o resultado final dividindo o numero de experiencias com 2
% caras pelo numero total de experiencias:probSimulacao= sum(sucessos)/10000

N=10000;

experiencas=rand(3,N);
lancamentos=experiencas>0.5;
r=sum(lancamentos); %soma as colunas
sucessos=r==2;% quando sair duas vezes cara
sum(sucessos)/N
